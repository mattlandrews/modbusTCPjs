...
module.exports = class readHoldingRegistersRequest extends modbusQuery {
    ...
    setReadAddress (readAddress) {
        if ((typeof readAddress !== "number") || (readAddress < 0) || (readAddress > 65535)) { throw new Error("invalid read address"); }
    ...
    setReadLength (readLength) {
        if ((typeof readLength !== "number") || (readLength < 1) || (readLength > 125)) { throw new Error("invalid read length"); }
