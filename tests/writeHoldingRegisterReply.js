...
const writeHoldingRegisterReply = require("../src/writeHoldingRegisterReply.js");
const expect = require("chai").expect;

describe("writeHoldingRegisterReply", function () {
    it("#writeHoldingRegisterReply()", function () {
        let query = new writeHoldingRegisterReply();
