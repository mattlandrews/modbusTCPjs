...
describe("modbusReply", function () {
    ...
    it("#modbusReply() creates a valid readHoldingRegister reply (1 - [0])", function () {
        ...
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x01, 0x03, 0x02, 0x00, 0x00]));
    });
    it("#modbusReply() creates a valid readHoldingRegister reply (2 - [1,2])", function () {
        ...
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x01, 0x00, 0x00, 0x00, 0x07, 0x01, 0x03, 0x04, 0x00, 0x01, 0x00, 0x02]));
    });
    it("#modbusReply() creates a valid writeHoldingRegisters reply (1)", function () {
        ...
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x02, 0x00, 0x00, 0x00, 0x06, 0x01, 0x10, 0x00, 0x64, 0x00, 0x01]));
    });
    it("#modbusReply() creates a valid writeHoldingRegisters reply (2)", function () {
        ...
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x03, 0x00, 0x00, 0x00, 0x06, 0x01, 0x10, 0x00, 0x65, 0x00, 0x02]));
    });        
    it("#modbusReply() creates a valid exception - illegal function", function () {
        ...
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x04, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x01]));
    });
    it("#modbusReply() creates a valid exception - illegal data address", function () {
        ...
        expect(reply.data).deep.equals([]);
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x02]));
    });
    ...
    it("#modbusReply() creates a valid exception - slave device failure", function () {
        ...
        expect(reply.data).deep.equals([]);
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x04]));
    });
    it("#modbusReply() creates a valid exception - acknowledge", function () {
        ...
        expect(reply.data).deep.equals([]);
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x05]));
    });
    it("#modbusReply() creates a valid exception - slave device busy", function () {
        ...
        expect(reply.data).deep.equals([]);
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x06]));
    });
    it("#modbusReply() creates a valid exception - negative acknowledge", function () {
        ...
        expect(reply.data).deep.equals([]);
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x07]));
    });
    it("#modbusReply() creates a valid exception - memory parity error", function () {
        ...
        expect(reply.data).deep.equals([]);
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x08]));
    });
    it("#modbusReply() creates a valid exception - gatway path unavailable", function () {
        ...
        expect(reply.data).deep.equals([]);
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x0A]));
    });
    it("#modbusReply() creates a valid exception - gateway target device failed to respond", function () {
        ...
        expect(reply.data).deep.equals([]);
        expect(reply.replyBuffer).deep.equals(new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x0B]));
    });
