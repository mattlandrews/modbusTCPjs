...
describe("modbusReply", function () {
    ...
    it("#modbusReply() creates a valid readHoldingRegister reply (1 - [0])", function () {
        ...
        reply.buffer = new Buffer([0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x01, 0x03, 0x02, 0x00, 0x00]);
        reply.bufferToReply();
    ...
    it("#modbusReply() creates a valid readHoldingRegister reply (2 - [1,2])", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x01, 0x00, 0x00, 0x00, 0x07, 0x01, 0x03, 0x04, 0x00, 0x01, 0x00, 0x02]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid writeHoldingRegisters reply (1)", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x02, 0x00, 0x00, 0x00, 0x06, 0x01, 0x10, 0x00, 0x64, 0x00, 0x01]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid writeHoldingRegisters reply (2)", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x03, 0x00, 0x00, 0x00, 0x06, 0x01, 0x10, 0x00, 0x65, 0x00, 0x02]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - illegal function", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x04, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x01]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - illegal data address", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x02]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - illegal data value", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x03]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - slave device failure", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x04]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - acknowledge", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x05]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - slave device busy", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x06]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - negative acknowledge", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x07]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - memory parity error", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x08]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - gatway path unavailable", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x0A]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
    ...
    it("#modbusReply() creates a valid exception - gateway target device failed to respond", function () {
        reply = new modbusReply();
        reply.buffer = new Buffer([0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x01, 0x80, 0x0B]);
        reply.bufferToReply();
        expect(reply).to.be.a("object")
