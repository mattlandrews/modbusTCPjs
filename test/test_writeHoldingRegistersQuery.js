...
const readHoldingRegistersQuery = require("../src2/writeHoldingRegistersQuery.js");

describe("writeHoldingRegistersQuery", function () {
    describe ("#writeHoldingRegistersQuery()", function () {
        it("should return a valid writeHoldingRegisters query (device 1, address 0, data [2])", function () {
            let query = new readHoldingRegistersQuery(1, 0, [2]);
            assert.strictEqual(query.transaction, 0);
            assert.strictEqual(query.protocol, 0);
